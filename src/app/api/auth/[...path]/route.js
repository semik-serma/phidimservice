...
async function handleAuthRoute(request, { params }) {
  ...
  // Copy all recorded cookies onto a mutable NextResponse using its cookie jar.
  // This is the officially supported App Router way; NextResponse serializes
  // Max-Age/Expires/HttpOnly/SameSite/Secure correctly and is NOT immutable
